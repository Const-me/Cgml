...
/// <summary>Unpickles an object graph from a pickle data inputstream. Supports all pickle protocol versions.
...
/// See the README.txt for a table with the type mappings.</summary>
