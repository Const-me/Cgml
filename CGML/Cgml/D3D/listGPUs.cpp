...
namespace DirectCompute
{
	...
	{
		if( requestedName == nullptr || 0 == *requestedName )
			return nullptr;
		...
		for( UINT i = 0; true; i++ )
		{
			...
			if( hr == DXGI_ERROR_NOT_FOUND )
			{
				logWarning16( L"Requested GPU not found: \"%s\"", requestedName );
				return nullptr;
			}
...
HRESULT COMLIGHTCALL Cgml::listGPUs( pfnListAdapters pfn, void* pv )
{
